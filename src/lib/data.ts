...
export const needs = [
  { id: "laver", name: "Laver", icon: "droplets", description: "Nettoyez vos cheveux en douceur" },
  { id: "soigner", name: "Soigner", icon: "heart", description: "Réparez et nourrissez en profondeur" },
  { id: "coiffer", name: "Coiffer", icon: "scissors", description: "Stylisez avec soin" },
  { id: "brillance", name: "Brillance", icon: "sparkles", description: "Révélez l'éclat de vos cheveux" },
